...
public class Dates {
    ...
    public static CharSequence getRelativeTimeSpanString(Context context, final long time) {
        ...
        try {
            ...
            return getShortRelativeTimeSpanString(context, time);
        }
    }
    ...
    public static CharSequence getWidgetTimeString(Context context, final long time, final boolean abbreviated) {
    ...
    public static CharSequence getMessageDetailsTimeString(Context context, final long time) {
        ...
        return getOlderThanAYearTimestamp(context, time,
                context.getResources().getConfiguration().locale, false /*abbreviated*/,
                flags);
    }

    private static CharSequence getTimeString(Context context, final long time, final boolean abbreviated,
    ...
    private static CharSequence getThisYearTimestamp(Context context, final long time, final Locale locale,
