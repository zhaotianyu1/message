...
import com.android.messaging.tcl.ui.Contact;
...
public class ContactListItemData {
    ...
    public void binds(final Cursor cursor, final String alphabetHeader,int count) {

        String displayName = names[count];
        String destination = names[count];
        long contactId = count;
        long dataId = count+1000;
        final int destinationType = 0;
