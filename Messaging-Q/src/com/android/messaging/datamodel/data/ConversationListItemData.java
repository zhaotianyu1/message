...
public class ConversationListItemData {
    ...
    public void setmSnippetText(String SnippetText){
    ...
    private static final String CONVERSATION_LIST_VIEW_PROJECTION =
            ...
            // juphoon
            + DatabaseHelper.CONVERSATIONS_TABLE + '.' + ConversationColumns.RMS_THREAD_TYPE
            + " as " + ConversationListViewColumns.RMS_THREAD_TYPE + ", "
            + DatabaseHelper.CONVERSATIONS_TABLE + '.' + ConversationColumns.PRIORITY
            + " as " + ConversationListViewColumns.PRIORITY + ", "
            + DatabaseHelper.CONVERSATIONS_TABLE + '.' + ConversationColumns.SMS_THREAD_ID
            + " as " + ConversationListViewColumns.SMS_THREAD_ID + " ";
    ...
    public static class ConversationListViewColumns implements BaseColumns {
        ...
        // juphoon
        static final String RMS_THREAD_TYPE = ConversationColumns.RMS_THREAD_TYPE;
        static final String PRIORITY = ConversationColumns.PRIORITY;
        static final String SMS_THREAD_ID = ConversationColumns.SMS_THREAD_ID;
    }
    ...
    public static final String[] PROJECTION = {
        ...
        // juphoon
        ConversationListViewColumns.RMS_THREAD_TYPE,
        ConversationListViewColumns.PRIORITY, // juphoon
        ConversationListViewColumns.SMS_THREAD_ID, // juphoon
    };
     ...
     */
    public static ConversationListItemData getExistingConversations(final DatabaseWrapper dbWrapper) {
...
//            Assert.inRange(cursor.getCount(), 0, 1);
    ...
    // juphoon
    public int getRmsThreadType() {
        return mRmsThreadType;
    }
    ...
    private void dealGeoData() {
        if (RcsChatbotUtils.isGeoSms(mSnippetText)) {
            mPreviewUri = Uri.fromFile(new File(RcsChatbotUtils.getGeoFileBySms(mSnippetText)));
            mPreviewContentType = ContentType.APP_GEO_MESSAGE;
        }
    }
}
