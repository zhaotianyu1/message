...
public class MessagePartData implements Parcelable {
	...
	//juphoon
    public static MessagePartData createPublicMessagePart(final String messageText, final String contentType) {
        return new MessagePartData(messageText, contentType, Uri.parse("file://"), UNSPECIFIED_SIZE, UNSPECIFIED_SIZE, false);
    }
    ...
    public SQLiteStatement getInsertStatement(final DatabaseWrapper db,
        ...
        if (mContentUri != null && !isText ) {   // juphoon
    ...
    */
    ...
    public void writeToParcel(final Parcel dest, final int flags) {
        ...
        dest.writeString(mContributionId);
        dest.writeString(mTrafficType);
		//juphoon@}
    }
    ...
    //juphoon
    public static MessagePartData createMediaMessagePartWithText(final String caption,
            final String contentType, final Uri contentUri, final int width, final int height) {
        return new MessagePartData(null, caption, contentType, contentUri, width, height, true);
    }
