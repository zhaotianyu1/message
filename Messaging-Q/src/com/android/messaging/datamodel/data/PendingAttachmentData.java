...
public class PendingAttachmentData extends MessagePartData {
    ...
    /** juphoon 增加转发没有uri的类型(位置，图文) **/
    public static PendingAttachmentData createRcsPendingAttachmentData(final String contentType,
            final String caption) {
        return createPendingAttachmentData(caption, contentType, Uri.parse("file://"), UNSPECIFIED_SIZE,
                UNSPECIFIED_SIZE);
    }
    ...
    public void loadAttachmentForDraft(final DraftMessageData draftMessageData,
        ...
        new SafeAsyncTask<Void, Void, MessagePartData>(LOAD_MEDIA_TIME_LIMIT_MILLIS,
            ...
            protected MessagePartData doInBackgroundTimed(final Void... params) {
                ...
                if (ContentType.isImageType(contentType) || ContentType.isAudioType(contentType) ||
                        ContentType.isVideoType(contentType) || ContentType.isGeoType(contentType) || ContentType.isFileType(contentType)) {
