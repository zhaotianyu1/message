...
public class DatabaseUpgradeHelper {
    ...
    private int upgradeToVersion3(final SQLiteDatabase db) {
        db.execSQL("ALTER TABLE "+ DatabaseHelper.CONVERSATIONS_TABLE + " ADD COLUMN " + DatabaseHelper.ConversationColumns.RMS_THREAD_TYPE + " INT DEFAULT(0)");
        db.execSQL("ALTER TABLE "+ DatabaseHelper.CONVERSATIONS_TABLE + " ADD COLUMN " + DatabaseHelper.ConversationColumns.PRIORITY + " INT DEFAULT(0)");
