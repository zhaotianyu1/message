...
public class ResendMessageAction extends Action implements Parcelable {
    ...
    protected Object executeAction() {
        ...
        if (message != null && message.canResendMessage()) {
            ...
            final boolean isRms = message.getIsRms();//juphoon
			...
			//juphoon
            if (isRms) {
                new RcsMessageSender(Factory.get().getApplicationContext(), message.getSmsMessageUri(), timestamp).sendSpreadMessage();
