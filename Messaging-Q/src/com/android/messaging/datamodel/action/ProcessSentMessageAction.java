...
public class ProcessSentMessageAction extends Action {
    ...
    private static final String KEY_RMS = "is_rms"; // juphoon
    ...
    public static void processMmsSent(final int resultCode, final Uri messageUri,
        ...
        params.putBoolean(KEY_RMS, false); // juphoon
...
//juphoon
    public static void processMessageSentFastFailed(final String messageId,
            final Uri messageUri, final Uri updatedMessageUri, final int subId, final boolean isRms,
            final boolean isSms, final int status, final int rawStatus, final int resultCode) {
        final ProcessSentMessageAction action = new ProcessSentMessageAction();
        final Bundle params = action.actionParameters;
        params.putBoolean(KEY_SMS, isSms);
        params.putBoolean(KEY_RMS, isRms); // juphoon
    ...
    */
    ...
    protected Object executeAction() {
        ...
        final boolean isRms = actionParameters.getBoolean(KEY_RMS); // juphoon
        ...
        if (messageId != null) {
            ...
            final int httpStatusCode = actionParameters.getInt(KEY_HTTP_STATUS_CODE);
            processResult(
                    messageId, updatedMessageUri, status, rawStatus, isRms, isSms, this, subId, // juphoon
    ...
    static void processResult(final String messageId, Uri updatedMessageUri, int status,
            final int rawStatus, final boolean isRms, final boolean isSms, final Action processingAction,
        ...
        // juphoon
        if (SendMessageAction.updateMessageAndStatus(isRms, isSms, message, updatedMessageUri, failed)) {
