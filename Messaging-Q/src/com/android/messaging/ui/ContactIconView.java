...
public class ContactIconView extends AsyncImageView {
    ...
    public void setImageResourceUri(final Uri uri, final long contactId,
        ...
        if (uri == null) {
            ...
            Log.i("bbb","avatarType--:"+avatarType);
            ...
            if (!mDisableClickHandler) {
                setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(final View view) {
                         ...
                         * 群聊和chatbot头像点击处理
                         */
                        if (RcsGroupHelper.getGroupInfo(mNormalizedDestination) != null) {
                            Log.i("bbbb","cacasca");
                            return;
                        } else if (RcsChatbotHelper.isChatbotByServiceId(String.valueOf(mNormalizedDestination))) {
                            Log.i("bbbb","mNormalizedDestination");
                            Intent intent = new Intent(getContext(), RcsChatBotDetailActivity.class);
                            intent.putExtra(RcsChatBotDetailActivity.KEY_CHATBOT_NUMBER, mNormalizedDestination);
                            getContext().startActivity(intent);
                        } else {
                            Log.i("bbbb","showOrAddContact");
