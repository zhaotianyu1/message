...
import com.android.messaging.tcl.AddMessageFragement;
...
import com.juphoon.chatbotmaap.RcsChatbotVideoPlayerManager;
import com.juphoon.helper.mms.RcsChatbotHelperRecevier;
...
import static com.android.messaging.ui.conversation.ComposeMessageView.REQUEST_SEND_IMAGE_URI;
...
public class ConversationActivity extends BugleActionBarActivity
        ...
        ConversationActivityUiStateHost ,View.OnTouchListener{
    public static final int FINISH_RESULT_CODE = 1;
    private static final String SAVED_INSTANCE_STATE_UI_STATE_KEY = "uistate";

    //juphoon 动态注册广播 用于接收按钮reply和发送地图
    private RcsChatbotHelperRecevier rcsChatbotHelperBroadcast;
    public static final String BROADCAST_ACTION_SEND_REPLY = "com.juphoon.action.SEND_REPLY";
    public static final String BROADCAST_ACTION_SEND_GEO = "com.juphoon.action.SEND_GEO";
...
//                        e.printStackTrace();
//                    }
//                    View rootview = ConversationActivity.this.getWindow().getDecorView();
...
//    ContactRecipientAutoCompleteView mRecipientTextView;
//    public  void reipient(View view){
//        Log.i("xxx","弹出键盘------");
...
//                manager.showSoftInput(mRecipientTextView, 0);
//            }
//        }, 100);
//    }
    ...
    protected void onResume() {
        ...
        mIsPaused = false;
		//juphoon
        RcsCallWrapper.rcsCheckLoginAvailable();
    ...
    private void updateUiState(final boolean animate) {
        ...
        Log.i("cccc","needConversationFragment--:"+needConversationFragment);
        final boolean needContactPickerFragment = mUiState.shouldShowContactPickerFragment();
        Log.i("cccc","needContactPickerFragment--:"+needContactPickerFragment);
        ConversationFragment conversationFragment = getConversationFragment();

        // Set up the conversation fragment.
        if (needConversationFragment) {
            Log.i("cccc","needConversationFragment--:123");
            ...
            Log.i("cccc","needConversationFragment--:456");
        ...
        if (needContactPickerFragment) {
            Log.i("cccc","needContactPickerFragment--:1");
            if (contactPickerFragment == null) {
                Log.i("cccc","needContactPickerFragment--:2");
            ...
            Log.i("cccc","needContactPickerFragment--:3");
    ...
    protected void onActivityResult(final int requestCode, final int resultCode,
        ...
        if (requestCode == ConversationFragment.REQUEST_CHOOSE_ATTACHMENTS &&
            ...
            //juphoon
            if (ComposeMessageView.sIMediaChoose.get() != null) {
                ComposeMessageView.sIMediaChoose.get().onMediaActivityResult(requestCode, resultCode, data);
            }
        }
    }
