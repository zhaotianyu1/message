...
public class ContactPickerFragment extends Fragment implements ContactPickerDataListener,
    ...
    private TCLButton delete_edits;
    private TCLButton delete_editss;
...
//        delete_edits = view.findViewById(R.id.delete_edits);
//        delete_edits.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                maybeGetOrCreateConversation();
//            }
//        });
//        delete_editss = view.findViewById(R.id.delete_editss);
//        delete_editss.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                mRecipientTextView.setText("");
//            }
//        });
//        returnss = view.findViewById(R.id.returnss);
//        returnss.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View v) {
//
...
//                getActivity(), this));
        ...
        mRecipientTextView.setInputType(InputType.TYPE_CLASS_PHONE);


        mRecipientTextView.setOnKeyListener(new View.OnKeyListener() {
            @Override
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if(keyCode == KeyEvent.KEYCODE_DPAD_CENTER){
                    Log.i("xxx","dakai jianpan");
        ...
        mRecipientTextView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.i("xxx","dakai onClick");
                mRecipientTextView.requestFocus();
                final int baseInputType = InputType.TYPE_TEXT_FLAG_MULTI_LINE;
                mRecipientTextView.setInputType(baseInputType | InputType.TYPE_CLASS_PHONE);
                ImeUtil.get().showImeKeyboard(getActivity(), mRecipientTextView);
        ...
        mRecipientTextView.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(final Editable s) {
                ...
                if(BugleApplication.getInstance().isIsfinish()){
                    maybeGetOrCreateConversation();
                    BugleApplication.getInstance().setIsfinish(false);
                }
            }
        });
...
//        mCustomHeaderViewPager.setBackgroundResource(R.drawable.launcher_bg);
        // The view pager defaults to the frequent contacts page.
        mCustomHeaderViewPager.setCurrentItem(0);

        Log.i("result","mRecipientTextViews--:"+mRecipientTextView.getInputType());

//        mToolbar = (Toolbar) view.findViewById(R.id.toolbar);

//        mToolbar.setNavigationIcon(R.drawable.ic_arrow_back_light);
//        mToolbar.setNavigationIcon(R.drawable.chatbot_leftarrow);
