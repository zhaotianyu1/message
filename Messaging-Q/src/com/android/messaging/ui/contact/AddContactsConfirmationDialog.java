...
public class AddContactsConfirmationDialog implements DialogInterface.OnClickListener {
    ...
    public void showJuphoonStyleDialog(Context context) {
        final int cancelStringId = android.R.string.cancel;
        JuphoonStyleDialog.showDialog(context,
                context.getString(R.string.add_contact_confirmation_dialog_title),
                null,
                createBodyView(),
                context.getString(cancelStringId),
                null,
                "添加",
