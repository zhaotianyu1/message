...
public class ViewPagerTabStrip extends LinearLayout {
    ...
    public ViewPagerTabStrip(Context context, AttributeSet attrs) {
        ...
        int underlineColor = res.getColor(R.color.black3);

        int backgroundColor = res.getColor(R.color.black3);

        mSelectedUnderlinePaint = new Paint();
        mSelectedUnderlinePaint.setColor(underlineColor);
        setBackgroundResource(R.drawable.element_btn_background_normal);
