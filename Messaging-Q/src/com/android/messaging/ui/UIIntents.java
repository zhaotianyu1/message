...
public abstract class UIIntents {
    ...
    public abstract void launchConversationActivityWithRecoding(Context context, String conversationId, int recodingIndex);

    //juphoon @add{
    public abstract void launchConversationActivityWithSearch(Context context, String conversationId, int index);
    //juphoon @add}
