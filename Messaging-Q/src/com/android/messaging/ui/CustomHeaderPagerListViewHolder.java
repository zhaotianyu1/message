...
import com.android.messaging.tcl.ui.ContactsAdapter;
...
//    private final CursorAdapter mListAdapter;
    ...
    private final ContactsAdapter mListAdapter;
    ...
    public CustomHeaderPagerListViewHolder(final Context context,
        ...
        Log.i("cxz","----CustomHeaderPagerListViewHolder------------:");
    }
    //RecyclerView布局管理器
    ...
    protected View createView(ViewGroup container) {
        ...
        Log.i("cxz","----CustomHeaderPagerListViewHolder----createView--------:");
        final View view = inflater.inflate(
                getLayoutResId(),
                null /* root */,
                false /* attachToRoot */);
        final RecyclerView listView = (RecyclerView) view.findViewById(getListViewResId());
    ...
    private void maybeSetEmptyView() {
        if (mView != null && mListCursorInitialized) {
            ...
            if (emptyView != null) {
                ...
                final RecyclerView listView = (RecyclerView) mView.findViewById(getListViewResId());
