...
public class AsyncImageViews extends ImageView implements MediaResourceManager.MediaResourceLoadListener<ImageResource> {
    ...
    private AsyncImageViewDelayLoaders mDelayLoader;
    private ImageRequestDescriptor mDetachedRequestDescriptor;

    public AsyncImageViews(final Context context, final AttributeSet attrs) {
        super(context, attrs);
     ...
     */
    public void setDelayLoader(final AsyncImageViewDelayLoaders delayLoader) {
...
//        setMeasuredDimension(width, height);
     ...
     */
    public static class AsyncImageViewDelayLoaders {
        private boolean mShouldDelayLoad;
        private final HashSet<AsyncImageViews> mAttachedViews;

        public AsyncImageViewDelayLoaders() {
            mAttachedViews = new HashSet<AsyncImageViews>();
        }

        private void registerView(final AsyncImageViews view) {
            mAttachedViews.add(view);
        }

        private void unregisterView(final AsyncImageViews view) {
        ...
        public void onResumeLoading() {
            if (mShouldDelayLoad) {
                ...
                for (final AsyncImageViews view : mAttachedViews) {
                    view.resumeLoading();
                }
