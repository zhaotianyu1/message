...
public abstract class MediaChooser extends BasePagerViewHolder
    ...
    void onCreateTabButton(final LayoutInflater inflater, final ViewGroup parent) {
        ...
        mTabButton = (ImageButton) inflater.inflate(
                ...
                parent,
                false /* addToParent */);
        mTabButton.setBackgroundResource(getIconResource());
...
//        count +=1;
        ...
        mTabButton.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
//                mMediaPicker.selectChooser(MediaChooser.this);

                Log.i("icon","hasfouc---:"+hasFocus);
//                if(hasFocus){
//                    mTabButton.setImageResource(getIconFoucusResource());
//                }else{
//                    mTabButton.setImageResource(getIconResource());
//                }
            }
        });
        mTabButton.setOnKeyListener(new View.OnKeyListener() {
            @Override
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                Log.i("icon","onKey---:"+event.getAction());
    ...
    abstract int getIconFoucusResource();
