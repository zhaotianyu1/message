...
public class CameraMediaChooserView extends FrameLayout implements PersistentInstanceState {
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        Log.i("vvv","isHardwareAccelerated--:"+isHardwareAccelerated());
        Log.i("vvv","canvas.isHardwareAccelerated()--:"+canvas.isHardwareAccelerated());
        Log.i("vvv","mIsSoftwareFallbackActive--:"+mIsSoftwareFallbackActive);
        if (!canvas.isHardwareAccelerated() && !mIsSoftwareFallbackActive) {
            Log.i("vvv","12321321323213123");
