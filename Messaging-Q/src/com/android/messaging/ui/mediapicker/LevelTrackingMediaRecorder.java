...
public class LevelTrackingMediaRecorder {
    ...
    private static final int MEDIA_RECORDER_OUTPUT_FORMAT = MediaRecorder.OutputFormat.AMR_NB;//juphoon
    private static final int MEDIA_RECORDER_AUDIO_ENCODER = MediaRecorder.AudioEncoder.AMR_NB;

    // juphoon Rcs消息语音大小限制10M
    private static final int MAX_AUDIO_FILE_SIZE = 10 * 1024 * 1024;
    // juphoon Rcs消息语音时长限制60秒
    private static final int MAX_AUDIO_DURATION = 60 * 1000;
