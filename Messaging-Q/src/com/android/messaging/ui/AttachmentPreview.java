...
public class AttachmentPreview extends ScrollView implements OnAttachmentClickListener {
    ...
    protected void onFinishInflate() {
        ...
        mCloseButton.setOnFocusChangeListener(new OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                Log.i("mnn","hasFocus--------------:"+hasFocus);
                if(hasFocus){
                    mCloseButton.setBackgroundResource(R.drawable.ic_remove_hight_light);
                }else{
                    mCloseButton.setBackgroundResource(R.drawable.ic_remove_light);
                }
            }
        });
        fragment_attchch = findViewById(R.id.fragment_attchch);
        mAttachmentView = (FrameLayout) findViewById(R.id.attachment_view);
        fragment_attchch.setOnFocusChangeListener(new OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                if(hasFocus){
                    ofFloatAnimator(fragment_attchch, 1f, 1.02f);//放大
                }else{
                    ofFloatAnimator(fragment_attchch, 1.02f, 1f);//缩小
                }
            }
        });
    ...
    public boolean onAttachmentClick(final MessagePartData attachment,
        ...
        Log.i("nnnn","onAttachmentClick==true");
