...
import com.android.messaging.tcl.TCLSettingActivity;
...
public class UIIntentsImpl extends UIIntents {
    ...
    public void launchConversationActivityWithRecoding(Context context, String conversationId, int recodingIndex) {
        TaskStackBuilder.create(context)
                .addNextIntentWithParentStack(
                        getConversationActivityIntent(context, conversationId, null,
                                false /* withCustomTransition */).putExtra(UIIntents.COMPOSE_RECORDING_INDEX, recodingIndex))
                .startActivities();
    }
...
//        startExternalActivity(context, intent);
    ...
    public void launchApplicationSettingsActivity(final Context context, final boolean topLevel) {
        final Intent intent = new Intent(context, TCLSettingActivity.class);
