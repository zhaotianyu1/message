...
//        play_controller_image.setImageResource(R.drawable.video_play_blue);
        ...
        Log.i("ztyzty","name.getScheme--:"+name);
        /**
         * 网络播放
         */
...
//    public void movie_return(View view){
//
//        Bundle sceneTransitionAnimationOptions = null;
//        boolean hasCustomTransitions = false;
//        String conversationId = BugleApplication.getInstance().getConversionid();
...
//    }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        Log.i("ztyzty","screenOritentation"+screenOritentation);
...
//            volume_Image.setVisibility(View.GONE);
    ...
    private void setVideoScreenSize(int width, int height) {
        Log.i("ztyzty","setVideoScreenSize");
        //获取视频控件的布局参数
...
//        volume_seek = (SeekBar) findViewById(R.id.main_volume_seek);
        ...
        play_controller_image.setFocusable(true);
        play_controller_image.setFocusableInTouchMode(true);
        play_controller_image.requestFocus();
