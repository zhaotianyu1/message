...
public class ShareIntentAdapter
    ...
    public void bindViewHolder(final ShareIntentViewHolder holder, final Context context,
            final Cursor cursor , int position) {
        holder.bind(cursor);
    }

    @Override
    public void bindViewHolder_message(ShareIntentViewHolder holder, Context context, Cursor cursor, int position, List<ConversationMessageData> conversationListItemDataList) {

    }

    @Override
    public void bindViewHolder_list(ShareIntentViewHolder holder, Context context, Cursor cursor, int position, List<ConversationListItemData> conversationListItemDataList) {
