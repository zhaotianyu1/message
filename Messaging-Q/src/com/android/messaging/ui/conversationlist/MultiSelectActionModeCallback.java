...
public class MultiSelectActionModeCallback implements Callback {
    ...
    public interface Listener {
        ...
        // juphoon
        void onActionBarPriority(Iterable<SelectedConversation> conversations,
    ...
    static class SelectedConversation {
        ...
        public final int rmsThreadType;
        ...
        public SelectedConversation(ConversationListItemData data) {
            ...
            smsThreadId = data.getSmsThreadId();
            rmsThreadType = data.getRmsThreadType();
    ...
    // juphoon 
    private MenuItem mSetPriorityMenuItem;
    private MenuItem mCancelPriorityMenuItem;
    ...
    public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
        ...
        //juphoon
        mSetPriorityMenuItem = menu.findItem(R.id.action_set_priority);
        mCancelPriorityMenuItem = menu.findItem(R.id.action_cancel_priority);
        mHasInflated = true;
    ...
    public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
        switch(menuItem.getItemId()) {
            ...
            case R.id.action_set_priority:
                mListener.onActionBarPriority(mSelectedConversations.values(), true);
                return true;
            // juphoon 取消置顶
            case R.id.action_cancel_priority:
                mListener.onActionBarPriority(mSelectedConversations.values(), false);
                return true;
            default:
                return false;
        }
    ...
    private void updateActionIconsVisiblity() {
        ...
        if (mSelectedConversations.size() == 1) {
            ...
            // juphoon 增加对我的电脑的菜单处理
            final String otherParticipant = conversation.otherParticipantNormalizedDestination;
            mAddContactMenuItem.setVisible((conversation.rmsThreadType == RmsDefine.COMMON_THREAD)
                    && !TextUtils.equals(otherParticipant, RmsDefine.PC_ADDRESS)
                    /*&& !conversation.isGroup*/ && !isInContacts);
            ...
            mBlockMenuItem.setVisible(otherParticipant != null
                    ...
                    && (conversation.rmsThreadType == RmsDefine.COMMON_THREAD
                    && !TextUtils.equals(otherParticipant, RmsDefine.PC_ADDRESS)));//juphoon
        } else {
        ...
        // juphoon
        boolean hasCurrentlySetPriority = false;
        boolean hasCurrentlyCancelPriority = false;
        ...
        for (final SelectedConversation conversation : conversations) {
            ...
            if (conversation.priority > 0) {
                hasCurrentlySetPriority = true;
            } else {
                hasCurrentlyCancelPriority = true;
            }
            ...
            if (hasCurrentlyOffNotification && hasCurrentlyOnNotification &&
                    ...
                    hasCurrentlySetPriority && hasCurrentlyCancelPriority) { // juphoon
                break;
            }
        }
        ...
        // juphoon
        mSetPriorityMenuItem.setVisible(hasCurrentlyCancelPriority);
        mCancelPriorityMenuItem.setVisible(hasCurrentlySetPriority);
    }
}
