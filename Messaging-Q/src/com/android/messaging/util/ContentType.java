...
public final class ContentType {
     ...
     * juphoon
     */
    public static String AUDIO_AMR_EXTENSION = "amr";
     ...
     * juphon 地理位置消息
     */
    public static final int TYPE_GEO = 100;
     ...
     * juphoon 名片烈性
     */
    public static final String RCS_TEXT_VCARD    = "text/vcard";
     ...
     * juphoon 地理位置
     */
    public static final String APP_GEO_MESSAGE   = "application/vnd.gsma.rcspushlocation+xml";
    /**
     * juphoon 文件消息
     */
    public static final String APP_FILE_MESSAGE  = "application/octet-stream";

    /**
     * juphoon 国标 maap 卡片消息
     */
    public static final String APP_CHATBOT_CARD_MESSAGE = "application/chatbot+card";

    /**
     * juphoon pdf
     */
    public static final String APP_CHATBOT_WORD = "application/msword";

    /**
     * juphoon chatbotDoc
     */
    public static final String APP_CHATBOT_DOC = "application/vnd.openxmlformats-officedocument.wordprocessingml.document";

    /**
     * juphppn pdf
     */
    public static final String APP_CHATBOT_PDF = "application/pdf";
    ...
    public static boolean isMediaType(final String contentType) {
        return isImageType(contentType)
                ...
                /** juphoon */
                || isGeoType(contentType)
                || isFileType(contentType)
                || isChatbotCard(contentType);
    }
    ...
    public static boolean isVCardType(final String contentType) {
        return (null != contentType) && (contentType.equalsIgnoreCase(TEXT_VCARD) ||
                /** juphoon */
                contentType.equalsIgnoreCase(RCS_TEXT_VCARD));
    }
    ...
    public static boolean isConversationListPreviewableType(final String contentType) {
        return ContentType.isAudioType(contentType) || ContentType.isVideoType(contentType) ||
                ...
                /** juphoon */
                ContentType.isGeoType(contentType) || ContentType.isFileType(contentType)
                || ContentType.isChatbotCard(contentType);
    }
    ...
    public static String getExtension(final String contentType) {
        ...
        /** juphoon */
        else if (AUDIO_AMR.equals(contentType)) {
            return AUDIO_AMR_EXTENSION;
        } else {
            return DEFAULT_EXTENSION;
        }
    }

    public static boolean isChatBotFileType(final String contentType) {
        return !TextUtils.isEmpty(contentType)
                && (contentType.equalsIgnoreCase(APP_CHATBOT_WORD) ||
                contentType.equalsIgnoreCase(APP_CHATBOT_DOC) ||
                contentType.equalsIgnoreCase(APP_CHATBOT_PDF)
        );
    }
     ...
     * @return
     */
    public static boolean isFileType(final String contentType) {
        return !TextUtils.isEmpty(contentType) && (contentType.equalsIgnoreCase(APP_FILE_MESSAGE) || isChatBotFileType(contentType));
    }
     ...
     * @return
     */
    public static boolean isGeoType(final String contentType) {
        return !TextUtils.isEmpty(contentType) && contentType.equalsIgnoreCase(APP_GEO_MESSAGE);
    }
     ...
     * @return
     */
    public static boolean isChatbotCard(final String contentType) {
        return !TextUtils.isEmpty(contentType) && contentType.equalsIgnoreCase(APP_CHATBOT_CARD_MESSAGE);
    }
